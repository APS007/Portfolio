...
import DevImage from '../../public/images/profile/aboutpage photocopy.jpg'
...
const about = () => {
    return (
        <>
            ...
            <main className='flex w-full grid-cols-8 gap-16'>
                <Layout className='pt-16'>
                    <AnimatedText text='Passion Fuels Purpose!' className='mb-16' />
                    <div className='grid w-full grid-cols-8 gap-16'>
                        <div className='col-span-3 flex-flex-col items-start justify-start'>
                            <h2 className='mb-4 text-lg font-bold uppercase text-black/75'>Biography</h2>
                            <p className='font-medium my-4'> Hi, I'm Abhishek, a Full Stack Developer with a passion for creating beautiful , functional,
                        ...
                        <div className='col-span-3 relative h-max rounded-2xl border-2 border-solid border-black bg-white p-8'>
                            ...
                            <Image src={DevImage} alt='Abhishek Image' className='w-full h-auto rounded-2xl' />
                        </div>
